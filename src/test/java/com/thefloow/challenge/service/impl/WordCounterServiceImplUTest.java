...
import static com.thefloow.challenge.helper.TestConstantsUtil.FIXTURES_PART_FILE_AB_PATH;
...
public class WordCounterServiceImplUTest {
    ...
    public void givenValidFileAndValidSplitSize_whenSplitFile_thenReturnExpected() throws FileReadingException {
            Map<String, Long> map = classUnderTest.countWords(Paths.get(FIXTURES_PART_FILE_AB_PATH));
            assertTrue(!map.isEmpty());
            assertEquals(map.size(), 7601);
    }
